...
<div class="wrapper">
	...
	<div class="content">
		...
		<div class="Page">
				<?php
/*Проверка на аватар и подстановка нужного*/
				...
				<br><input type="password" name="opassword" placeholder="Старый пароль" maxlength = "15" pattern="[A-Za-z-0-9]{5,15}" title="Не более 5 и менее 15 латинских символов или цифр." >
				<br><input type="password" name="npassword" placeholder="Новый пароль" maxlength = "15" pattern="[A-Za-z-0-9]{5,15}" title="Не более 5 и менее 15 латинских символов или цифр." >
				<br><input type="text" name="name" placeholder="Имя" maxlength = "10" pattern="[А-Яа-яЁё]{4,10}" title="Не более 4 и менее 10 русских символов или цифр." value="'.$_SESSION['USER_NAME'].'" required>
<!-- Ищем совпадение >и значения и выводим согласно оптиона-->
